...
export default function About() {
  return (
    <section id="sobre" className="relative py-24 sm:py-32 overflow-hidden">
      <div className="absolute top-1/2 -translate-y-1/2 right-0 h-[400px] w-[400px] rounded-full bg-eco-100/40 blur-[100px] -z-10" />
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="reveal">
            ...
            <h2 className="mt-5 font-display text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight text-tech-900">
              Engenharia de software com{' '}
              <span className="text-gradient-eco">propósito sustentável</span>
            </h2>
            <p className="mt-6 text-lg text-tech-500 leading-relaxed">
            ...
            <p className="mt-4 text-tech-500 leading-relaxed">
            ...
            <div className="mt-10 grid sm:grid-cols-2 gap-5">
              {pillars.map((p) => (
                <div
                  key={p.title}
                  className="group flex items-start gap-4 rounded-2xl border border-tech-100 bg-white p-5 transition-all duration-300 hover:border-eco-200 hover:shadow-lg hover:shadow-eco-500/5"
                >
                  ...
                  <div>
                    <h3 className="font-semibold text-tech-900">{p.title}</h3>
                    <p className="mt-1 text-sm text-tech-500">{p.desc}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="reveal relative" style={{ transitionDelay: '0.15s' }}>
            <div className="relative grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <div className="rounded-3xl bg-gradient-to-br from-eco-500 to-eco-700 p-6 text-white shadow-xl shadow-eco-500/20 aspect-square flex flex-col justify-between">
                ...
                <div className="rounded-3xl bg-tech-900 p-6 text-white shadow-xl aspect-video flex flex-col justify-between">
              ...
              <div className="space-y-4 mt-8">
                <div className="rounded-3xl bg-white border border-tech-100 p-6 shadow-xl aspect-video flex flex-col justify-between">
                  <ShieldCheck className="h-7 w-7 text-eco-600" />
                  <div>
                    <div className="font-display text-2xl font-bold text-tech-900">ISO 27001</div>
                    <div className="text-sm text-tech-500">Segurança de dados</div>
                  </div>
                </div>
                <div className="rounded-3xl bg-gradient-to-br from-tech-800 to-tech-900 p-6 text-white shadow-xl aspect-square flex flex-col justify-between">
